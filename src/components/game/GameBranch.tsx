...
export const GameBranch: React.FC<GameBranchProps> = ({
  ...
  return (
    <div className="flex flex-col items-center space-y-2">
      <div
        className={cn(
          "relative w-80 h-20 rounded-2xl bg-gradient-branch shadow-md",
          "border-2 border-branch transition-all duration-300 cursor-pointer",
          "flex items-center justify-start p-2 gap-1",
      ...
      >
        {/* Tiles arranged horizontally from left */}
        ...
        {isEmpty && (
          <div className="absolute left-2 w-14 h-14 rounded-xl border-2 border-dashed border-muted-foreground/30 flex items-center justify-center">
